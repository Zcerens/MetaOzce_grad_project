...
Widget _buildDetailBox(
  ...
  return Center(
    child: Container(
      ...
      height: MediaQuery.of(context).size.height * 0.5, // Gerekirse genişliği ayarlayın
      child: Card(
    ...
    child: Padding(
      ...
      child: TextButton(
        onPressed: () {
          setState(() {
            try {
              int userId = int.parse(userIdSon);
              createHotelUserHistory(responseData["id"], userId);
            } catch (e) {
              // Hata durumunda yapılacak işlemler
              print('Invalid userId: $userIdSon');
            }
          });
        },
